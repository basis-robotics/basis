...
namespace basis {
  ...
  bool Recorder::WriteMessage(const std::string &topic, const std::span<const std::byte>& payload, const basis::core::MonotonicTime &now) {
    mcap::Message msg;
  ...
  bool Recorder::RegisterTopic(const std::string& topic, const core::serialization::MessageTypeInfo& message_type_info, std::string_view schema_data) {
